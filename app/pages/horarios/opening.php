...
<body>
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu rounded-0 m-0">
                <a href="../horarios/appointment.php" class="dropdown-item"
                  >Agendamentos</a
                >
                <a href="../horarios/opening.php" class="dropdown-item active"
            ...
            <div class="row">
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="../../../public/assets/img/woman-with-nail-art-promoting-design-luxury-earrings-ring.jpg" style="object-fit: cover;">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <p class="m-0 text-white">Designed by <a href="https://freewebsitecode.com">Free Website Code</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../../../public/assetslib/easing/easing.min.js"></script>
    <script src="../../../public/assetslib/waypoints/waypoints.min.js"></script>
    <script src="../../../public/assetslib/counterup/counterup.min.js"></script>
    <script src="../../../public/assetslib/owlcarousel/owl.carousel.min.js"></script>
    <script src="../../../public/assetslib/tempusdominus/js/moment.min.js"></script>
    <script src="../../../public/assetslib/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="../../../public/assetslib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>

    <!-- Contact Javascript File -->
    <script src="../../../public/assetsmail/jqBootstrapValidation.min.js"></script>
    <script src="../../../public/assetsmail/contact.js"></script>

    <!-- Template Javascript -->
    <script src="../../../public/assetsjs/main.js"></script>
</body>
