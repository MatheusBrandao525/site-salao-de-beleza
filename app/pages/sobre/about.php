      ...
      >
        <a href="index.html" class="navbar-brand ml-lg-3">
          <h1 class="m-0 text-primary">
            <span class="text-dark">SPA</span> Center
          </h1>
        </a>
        <button
          type="button"
        ...
        <div class="navbar-nav m-auto py-0">
            ...
            <a href="../sobre/about.php" class="nav-item nav-link active">Sobre</a>
      ...
      <div class="container py-5">
        <div class="row align-items-center">
          <div class="col-lg-6 pb-5 pb-lg-0">
            <img class="img-fluid w-100" src="../../../public/assets/img/about.jpg" alt="" />
          </div>
          <div class="col-lg-6">
            <h6
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="team position-relative overflow-hidden mb-5">
              <img class="img-fluid" src="../../../public/assets/img/team-1.jpg" alt="" />
          ...
          <div class="col-lg-3 col-md-6">
            <div class="team position-relative overflow-hidden mb-5">
              <img class="img-fluid" src="../../../public/assets/img/team-2.jpg" alt="" />
              <div class="position-relative text-center">
                <div class="team-text bg-primary text-white">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="team position-relative overflow-hidden mb-5">
              <img class="img-fluid" src="../../../public/assets/img/team-3.jpg" alt="" />
              <div class="position-relative text-center">
                <div class="team-text bg-primary text-white">
