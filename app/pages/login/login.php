    ...
    <div class="container-fluid p-0">
      ...
      >
        ...
        <div class="navbar-nav m-auto py-0">
            ...
            <a href="../contato/contact.php" class="nav-item nav-link active">Contato</a>
          </div>
          ...
          <div class="p-5 my-5" style="background: rgba(33, 30, 28, 0.7)">
            ...
            <form action="../../../adm/manipulacoes/validarUser/validarusuario.php" method="post" enctype="multipart/form-data">
              ...
              <div class="form-row">
                ...
                <div class="col-sm-12 text-center" style="border-bottom: 1px solid #fff; margin: 20px 0">
                <span class="">Ou</span>
                </div>
                <div class="col-sm-12">
                  <button
                    ...
                    type="submit"
                    style="height: 47px ;border: 1px solid #fff;"
                  >
                    Cadastrar-se
                  </button>
                </div>
